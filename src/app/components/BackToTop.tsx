...
export default function BackToTop() {
  ...
  return (
    <div className="fixed bottom-6 sm:bottom-8 right-6 sm:right-8 z-[100] flex flex-col items-center gap-3">
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="w-11 h-11 sm:w-12 sm:h-12 bg-msh-red hover:bg-msh-gold text-white rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
